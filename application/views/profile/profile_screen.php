          ...
          <div class="col-sm-10 order-md-last d-flex">
            ...
            <form id="insert" class="bg-light p-4 contact-form">
              ...
              <div class="row">
                    ...
                    <div class="col">
                        <div align='left'><label text>สัญชาติ :</label></div>
                         <input type="text" class="form-control" placeholder="" id="name" name="name" disabled > 
                    </div>
              </div>
              ...
              <div class="form-group">
                <div class="row">
                    <div class="col">
                <button type="insert"  class="btn btn-secondary py-3 px-5">แก้ไขข้อมูลผู้ใช้</button>
                    </div>
                    <div class="col">
